...
public class XxlJobInfoDaoTest {
	...
	public void pageList(){
		List<XxlJobInfo> list = xxlJobInfoService.pageList(0, 20, 0, -1, null, null, null);
		long list_count = xxlJobInfoService.pageListCount(0, 20, 0, -1, null, null, null);
		
		System.out.println(list);
		System.out.println(list_count);

		List<XxlJobInfo> list2 = xxlJobInfoService.getJobsByGroup(1);
	}
	...
	public void save_load(){
		...
		int count = xxlJobInfoService.save(info);

		XxlJobInfo info2 = xxlJobInfoService.loadById(info.getId());
		info.setScheduleType(ScheduleTypeEnum.FIX_RATE.name());
		...
		int item2 = xxlJobInfoService.update(info2);

		xxlJobInfoService.delete(info2.getId());

		List<XxlJobInfo> list2 = xxlJobInfoService.getJobsByGroup(1);

		long ret3 = xxlJobInfoService.findAllCount();
