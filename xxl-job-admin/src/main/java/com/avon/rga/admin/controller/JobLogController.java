...
import com.avon.rga.admin.core.complete.XxlJobCompleter;
...
import com.avon.rga.admin.core.scheduler.XxlJobScheduler;
import com.avon.rga.admin.core.util.I18nUtil;
import com.avon.rga.admin.dao.XxlJobGroupService;
import com.avon.rga.admin.dao.XxlJobInfoService;
import com.avon.rga.admin.dao.XxlJobLogService;
...
public class JobLogController {
	...
	public ReturnT<String> logKill(int id){
		...
		XxlJobInfo jobInfo = xxlJobInfoService.loadById(log.getJobId());
		if (jobInfo==null) {
