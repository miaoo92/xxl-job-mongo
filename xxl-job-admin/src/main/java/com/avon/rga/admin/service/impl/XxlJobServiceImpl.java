package com.avon.rga.admin.service.impl;

import com.avon.rga.admin.core.cron.CronExpression;
...
public class XxlJobServiceImpl implements XxlJobService {
		...
		if (jobInfo.getChildJobId()!=null && jobInfo.getChildJobId().trim().length()>0) {
			...
			for (String childJobIdItem: childJobIds) {
				if (childJobIdItem!=null && childJobIdItem.trim().length()>0 && isNumeric(childJobIdItem)) {
					XxlJobInfo childJobInfo = xxlJobInfoService.loadById(Integer.parseInt(childJobIdItem));
	...
	public Map<String, Object> dashboardInfo() {
		...
		long jobInfoCount = xxlJobInfoService.findAllCount();
		int jobLogCount = 0;
